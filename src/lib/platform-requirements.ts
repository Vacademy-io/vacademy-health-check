...
export const PLATFORM_FIELDS: Record<Platform, FieldSpec[]> = {
  ...
  IOS: [
    ...
    { id: "release_track", label: "Release Track", type: "select", required: true, options: ["TestFlight — internal testers", "TestFlight — external testers", "App Store (production)"], helpText: "Where this build is being distributed right now. External TestFlight needs its own Beta App Review; only the App Store track is publicly downloadable." },
  ...
  WINDOWS: [
    ...
    { id: "release_track", label: "Release Track", type: "select", required: true, options: ["Package flight (private)", "Production"], helpText: "A package flight is only downloadable by the testers on its list; Production is the public Store listing." },
  ...
  MACOS: [
    ...
    { id: "release_track", label: "Release Track", type: "select", required: true, options: ["TestFlight — internal testers", "TestFlight — external testers", "Mac App Store (production)"], helpText: "Where this build is being distributed right now. Only the Mac App Store track is publicly downloadable." },
...
export const PLATFORM_CHECKLISTS: Record<Platform, ChecklistItem[]> = {
  ...
  IOS: [
    ...
    { id: "i_track", section: "Submission", label: "Release track selected", required: true, help: "TestFlight or App Store — the institute is told which.", rule: { kind: "field", fieldId: "release_track" } },
  ...
  WINDOWS: [
    ...
    { id: "w_track", section: "Build", label: "Release track selected", required: true, help: "A package flight reaches only its tester list.", rule: { kind: "field", fieldId: "release_track" } },
  ...
  MACOS: [
    ...
    { id: "m_track", section: "Submission", label: "Release track selected", required: true, help: "TestFlight or Mac App Store — the institute is told which.", rule: { kind: "field", fieldId: "release_track" } },
